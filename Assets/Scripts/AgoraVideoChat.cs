...
public class AgoraVideoChat : Photon.MonoBehaviour
{
    ...
    private void CreateUserVideoSurface(uint uid, bool isLocalUser)
    {
        ...
        GameObject newUserVideo = Instantiate(userVideoPrefab, spawnPoint.position, spawnPoint.rotation);
        ...
        GetComponent<NetworkedUintManager>().UpdateUid(uid);
        ...
        {
            //newVideoSurface.transform.rotation = Quaternion.Euler(0, 0, 0);
        }
    }
